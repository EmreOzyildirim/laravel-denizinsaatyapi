...
@section('optional_description','Websitenizle ilgili tüm ayarları bu panelden yapabilirsiniz.')
    ...
    <div class="col-md-12">
        <div class="box box-solid">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-3">
                        <a href="compose.html" class="btn btn-primary btn-block margin-bottom">Yeni ileti oluştur</a>
                                ...
                                <div class="table-responsive mailbox-messages">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><a href="read-mail.html">emreozyildirim@outlook.com</a></td>
                                            <td class="mailbox-subject"><b>Ilan hakkında</b> - Trying to find a
