                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="province_id" id="provinces">
                                    @foreach($provinces as $item)
                                        <option value="{{$item['sehir_key']}}"{{$property['province_id'] == $item['sehir_key'] ? ' selected':''}}>{{$item['sehir_title']}}</option>
                                    @endforeach
                                </select>
                                @error('province_id')
                                <span class="text-danger">{{$message}}</span>
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="district_id" id="districts">
                                    @foreach($districts as $item)
                                        <option value="{{$item['ilce_key']}}"{{$property['district_id'] == $item['ilce_key'] ? ' selected':''}}>{{$item['ilce_title']}}</option>
                                    @endforeach
                                </select>
                                @error('district_id')
                                <span class="text-danger">{{$message}}</span>
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="neighborhood_id" id="neighborhoods">
                                    @foreach($neighborhoods as $item)
                                        <option value="{{$item['mahalle_key']}}"{{$property['neighborhood_id'] == $item['mahalle_key'] ? ' selected':''}}>{{$item['mahalle_title']}}</option>
                                    @endforeach
                                </select>
