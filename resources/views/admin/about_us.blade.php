...
@endsection
@section('page_title','Hakkımızda Sayfası - Düzenle')
@section('optional_description','Websitenizin Hakkımızda bölümünü buradan güncelleyebilirsiniz.')

@section('content')
    <div class="col-md-12">
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Hakkımızda Sayfası</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <img src="{{'/images/about-us/'.$about_us['content_side_image']}}" name="content_side_image" alt="Deniz Gayrimenkul Hakkımızda"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea type="text" name="description" class="form-control" id="description"
                                      placeholder="Hakkımızda sayfasında görünecek paragraf içeriğini giriniz...">{{$about_us['description']}}</textarea>
                            @error('url')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
