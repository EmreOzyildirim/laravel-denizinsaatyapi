...
<section class="property-section latest-property-section spad">
    <div class="container">
        ...
        <div class="row property-filter">
            @foreach($properties as $item)
                <div class="col-lg-4 col-md-6 mix {{'.'.$item['name']}}">
                    <div class="property-item">
                        <div class="pi-pic set-bg" data-setbg="{{$item['image_path']}}">
                            <div class="label">Satılık</div>
                        </div>
                        <div class="pi-text">
                            <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                            <div class="pt-price">{{$item['price']}} ₺</div>
                            <h5><a href="#">{{strlen($item['title'])>60 ?$item['title'].'..':$item['title']}}</a></h5>
                            ...
                            <div class="pi-agent">
                                <div class="pa-item">
                                    <div class="pa-info">
                                        <img src="/frontend/img/property/posted-by/pb-1.jpg" alt="">
            ...
            <div class="col-lg-4 col-md-6 mix all restaurent hotel">
                <div class="property-item">
                    <div class="pi-pic set-bg" data-setbg="/frontend/img/property/property-2.jpg">
            ...
            <div class="col-lg-4 col-md-6 mix all hotel restaruent">
                <div class="property-item">
                    <div class="pi-pic set-bg" data-setbg="/frontend/img/property/property-4.jpg">
                        <div class="label c-red">For rent</div>
                    </div>
                    <div class="pi-text">
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
            ...
            <div class="col-lg-4 col-md-6 mix all office hotel">
                <div class="property-item">
                    <div class="pi-pic set-bg" data-setbg="/frontend/img/property/property-5.jpg">
            ...
            <div class="col-lg-4 col-md-6 mix house apart office">
                <div class="property-item">
                    <div class="pi-pic set-bg" data-setbg="/frontend/img/property/property-6.jpg">
                        <div class="label">For rent</div>
                    </div>
                    <div class="pi-text">
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
...
<section class="chooseus-section spad set-bg" data-setbg="/frontend/img/chooseus/chooseus-bg.jpg">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="chooseus-features">
                    <div class="cf-item">
                        <div class="cf-pic">
                            <img src="/frontend/img/chooseus/chooseus-icon-1.png" alt="">
                        </div>
                        <div class="cf-text">
                    ...
                    <div class="cf-item">
                        <div class="cf-pic">
                            <img src="/frontend/img/chooseus/chooseus-icon-2.png" alt="">
                        </div>
                        <div class="cf-text">
                    ...
                    <div class="cf-item">
                        <div class="cf-pic">
                            <img src="/frontend/img/chooseus/chooseus-icon-3.png" alt="">
                        </div>
                        <div class="cf-text">
                    ...
                    <div class="cf-item">
                        <div class="cf-pic">
                            <img src="/frontend/img/chooseus/chooseus-icon-4.png" alt="">
                        </div>
                        <div class="cf-text">
...
<section class="categories-section">
    <div class="cs-item-list">
        @foreach($categories as $category)
            <div class="cs-item set-bg" data-setbg="{{$category['category']['image_path']}}">
                <div class="cs-text">
